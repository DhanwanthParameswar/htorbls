...
?>
<title>Demo Library System - Edit Entry</title>
...
<div class='form-floating mb-3'>
  <input id='contactInfo' name='contactInfo' type='text' placeholder='e.g. phone, email, or note' class='form-control input-md' required='' value='$contactInfo'>
