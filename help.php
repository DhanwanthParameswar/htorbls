...
<style type="text/css">
  ...
  <body style="width: 100%; min-height: 100vh; display: -webkit-box; display: -webkit-flex; display: -moz-box; display: -ms-flexbox; display: flex; flex-wrap: wrap; justify-content: center; align-items: center; padding: 15px; background: #F4CABC;">
      <div class="container text-center" style="width: 1000px; background: #fff; border-radius: 10px; overflow: hidden; padding: 77px 55px 33px 55px; box-shadow: 0 5px 10px 0px rgba(0, 0, 0, 0.1); -moz-box-shadow: 0 5px 10px 0px rgba(0, 0, 0, 0.1); -webkit-box-shadow: 0 5px 10px 0px rgba(0, 0, 0, 0.1); -o-box-shadow: 0 5px 10px 0px rgba(0, 0, 0, 0.1); -ms-box-shadow: 0 5px 10px 0px rgba(0, 0, 0, 0.1);">
        ...
        <p>Welcome to the Balvihar Library System (BLS)! This system is an internal management system for the Balvihar class of the <a href="https://www.hindutempleofrochester.com/">Hindu Temple of Rochester</a>. If it's your first time using this system or want a refresher, you can watch the training video below. To use this system, you'll need dedicated credentials. If you are unsure of these credentials or need general support/assistance with using the system, please contact one of the Balvihar coordinators or email <a href="mailto:balviharhtor@gmail.com">balviharhtor@gmail.com</a>. If you see an error box like the one below, find a technical issue with the system, or have feedback/feature requests, please email <a href="mailto:im@dhanwanth.com">im@dhanwanth.com</a>.</p>
...
<tr><td bgcolor="#eeeeec" align="center">-</td><td bgcolor="#eeeeec" align="center">-</td><td bgcolor="#eeeeec" align="right">-</td><td bgcolor="#eeeeec">-</td><td bgcolor="#eeeeec">-</td></tr>
        ...
        <iframe src="https://www.youtube.com/embed/EM5wSDQus4A?si=CV0zMUlSYVaOxjpe" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        <hr>
