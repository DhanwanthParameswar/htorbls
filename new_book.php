...
$bookId = normalize_book_id($_POST["bookId"] ?? '');
  ...
  echo "<h2>Creating a new entry:</h2><br><h4>Book Name: " . h($bookName) . "<br>Book Category: " . h($bookCategory) . "<br>Additional Notes: " . h($additionalNotes) . "<br>Book ID: " . h($bookId) . "</h4>";
  ...
  if ($check) {
    ...
    db_execute($mysqli,
      ...
      'ssss',
      [$bookId, $bookName, $bookCategory, $additionalNotes]
    );
  }
